...
class TestGraphFrames extends FunSpec
  ...
  describe("GraphFrames") {
    ...
    def doGraphTest(load: () => GraphFrame): Unit = {
      ...
      val expected = Set(
        Row(
          Row(sw1, "Film", "Star Wars: Episode IV - A New Hope", Timestamp.valueOf("1977-05-25 00:00:00.0"), 7.75E8, 121, 0.7968127490039841.toFloat),
          Row(sw1, leia, "starring", 0.25),
          Row(leia, "Person", "Princess Leia", null, null, null, 1.3047808764940239.toFloat),
        ),
        Row(
          Row(sw2, "Film", "Star Wars: Episode V - The Empire Strikes Back", Timestamp.valueOf("1980-05-21 00:00:00.0"), 5.34E8, 124, 0.7968127490039841.toFloat),
          Row(sw2, leia, "starring", 0.25),
          Row(leia, "Person", "Princess Leia", null, null, null, 1.3047808764940239.toFloat),
        ),
        Row(
          Row(sw3, "Film", "Star Wars: Episode VI - Return of the Jedi", Timestamp.valueOf("1983-05-25 00:00:00.0"), 5.72E8, 131, 0.7968127490039841.toFloat),
        ...
        Row(
          ...
          Row(irvin, "Person", "Irvin Kernshner", null, null, null, 0.9661354581673308.toFloat),
        ),
        Row(
          Row(sw1, "Film", "Star Wars: Episode IV - A New Hope", Timestamp.valueOf("1977-05-25 00:00:00.0"), 7.75E8, 121, 0.7968127490039841.toFloat),
          Row(sw1, han, "starring", 0.25),
          Row(han, "Person", "Han Solo", null, null, null, 1.3047808764940239.toFloat),
        ),
        Row(
          Row(sw2, "Film", "Star Wars: Episode V - The Empire Strikes Back", Timestamp.valueOf("1980-05-21 00:00:00.0"), 5.34E8, 124, 0.7968127490039841.toFloat),
        ...
        Row(
          ...
          Row(lucas, "Person", "George Lucas", null, null, null, 0.9661354581673308.toFloat),
        ),
        Row(
          Row(sw1, "Film", "Star Wars: Episode IV - A New Hope", Timestamp.valueOf("1977-05-25 00:00:00.0"), 7.75E8, 121, 0.7968127490039841.toFloat),
          Row(sw1, luke, "starring", 0.25),
          Row(luke, "Person", "Luke Skywalker", null, null, null, 1.3047808764940239.toFloat),
        ),
        Row(
          Row(sw2, "Film", "Star Wars: Episode V - The Empire Strikes Back", Timestamp.valueOf("1980-05-21 00:00:00.0"), 5.34E8, 124, 0.7968127490039841.toFloat),
        ...
        Row(
          ...
          Row(richard, "Person", "Richard Marquand", null, null, null, 0.9661354581673308.toFloat),
        )
      )
