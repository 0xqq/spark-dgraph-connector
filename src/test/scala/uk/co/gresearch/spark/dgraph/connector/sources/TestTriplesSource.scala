...
class TestTriplesSource extends FunSpec
  ...
  describe("TriplesDataSource") {
    ...
    it("should load as uid-range partitions") {
      ...
      val expected = Set(
        Some(Partition(Seq(Target(cluster.grpc)), None, Some(UidRange(0, 7)), None)),
        Some(Partition(Seq(Target(cluster.grpc)), None, Some(UidRange(7, 7)), None)),
      )
    ...
    it("should load as predicate uid-range partitions") {
      ...
      val expected = Set(
        ...
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("revenue", "float"))), None, None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("dgraph.graphql.schema", "string"), Predicate("running_time", "int"))), None, None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("dgraph.type", "string"), Predicate("dgraph.graphql.xid", "string"))), Some(UidRange(0, 5)), None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("dgraph.type", "string"), Predicate("dgraph.graphql.xid", "string"))), Some(UidRange(5, 5)), None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("dgraph.type", "string"), Predicate("dgraph.graphql.xid", "string"))), Some(UidRange(10, 5)), None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("director", "uid"), Predicate("name", "string"))), Some(UidRange(0, 5)), None)),
        Some(Partition(Seq(Target(cluster.grpc)), Some(Set(Predicate("director", "uid"), Predicate("name", "string"))), Some(UidRange(5, 5)), None))
      )
